...
public class JavaLibs5026211040 {
	...
	kalori = walk*15/50;  //kalori yang dibakar saat berjalan selama 15 menit berkisar 50 kalori
	...
	JOptionPane.showMessageDialog(null,
			...
			+ "Tak terasa kita telah mengelilingi kota " +city+ " selama " +walk+ " menit. Kita juga sudah membakar sekitar " +kalori+ " kalori dengan berjalan mengelilingi " +city+ " loh! /n"
			+ food+ " pun kita sudah mencobanya! Rasanya benar-benar enak. " +panggilan+ " bahkan hingga membeli " +food+ "sebanyak " +quantity+ ". Langit " +waktu+ " sangat cerah sehingga kami bisa menikmati makanan dengan segar. \n"
